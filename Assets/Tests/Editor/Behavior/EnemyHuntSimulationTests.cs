...
{
    /// <summary>
    /// Aggressive hunter (speed 2) hunts a passive prey that flees to a far cell.
    /// Hunter retargets prey cell / last-seen each turn.
    /// Board-only: no controlled slime — personality focus is null so hunt redirect owns mob↔mob.
    /// </summary>
    public class EnemyHuntSimulationTests
    {
        ...
        [Test]
        public void Corridor10_HunterAtVisionRange_HuntsPrey_PreyFlees_HunterCatches()
        {
            ...
            var dog = TestCreatures.Aggressive(spawned, new Vector2Int(0, 4));
        ...
        [Test]
        public void Maze10x10_HunterHuntsPreyAroundWalls_BothDetour()
        {
        ...
        [Test]
        public void WallTwoDoors_NearDot_HunterTakesFarSafeDoor(
        ...
        [Test]
        public void OnlyDotDoor_HunterWalksThroughTrap_GetsDebuff(
            [Values(typeof(Lava), typeof(Acid), typeof(Poison))] System.Type dotType
        )
        {
        ...
        [Test]
        public void Prey_HuntingCowardly_SwitchesToFlee_WhenHunterAppears()
        {
            // Passive is mid-hunt on a cowardly foe; hunter enters vision → FearsDogs beats HatesRats.
            ...
            var dog = TestCreatures.Aggressive(spawned, new Vector2Int(6, 7));
