...
{
    /// <summary>
    /// Cowardly enemy: retaliates while adjacent after taking a hit; flees once the slime breaks contact.
    /// </summary>
    public class EnemyRetaliateThenFleeTests : DuelFixture
    {
        [Test]
        public void Hit_EnemyAttacksBack_ThenFleeWhenSlimeStepsAway()
        {
